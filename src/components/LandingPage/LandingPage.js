    ...
    <div className="landing-page">
      ...
      <div className="intro-section flex justify-between items-center py-10">
        ...
        <div className="logo-section flex flex-col items-center">
          <img src={process.env.PUBLIC_URL + '/logos/logo2.svg'} alt="Logo" className="mb-4" />
      ...
      <div className="carousel-section flex justify-between items-center py-10">
        <div className="movie-card rounded-lg mr-4">
          <img src={process.env.PUBLIC_URL + '/images/shrek1.jpg'} alt="Movie 1" className="rounded-lg" />
          <p className="mt-2">12:30 PM, Melbourne Central</p>
        </div>
        <div className="movie-card rounded-lg">
        <img src={process.env.PUBLIC_URL + '/images/shrek2.jpg'} alt="Movie 2" className="rounded-lg" />
          <p className="mt-2">3:30 PM, Sunshine</p>
        </div>
      </div>

      {/* Section 3: Promotion */}
      <div className="promo-section flex justify-center items-center py-10 bg-yellow-300">
        <h2 className="text-2xl font-bold">Buy one get none free</h2>
      </div>
